...
TEST_F(PullTest, WeightOneOrZero)
{
    ...
    pgrp.localWeightFactors.resize(pgrp.atomSet.numAtomsLocal());
...
TEST_F(PullTest, WeightSumPositionOrVelocity)
{
    ...
    pgrp0.localWeightFactors.resize(pgrp0.atomSet.numAtomsLocal());
    pgrp1.localWeightFactors.resize(pgrp1.atomSet.numAtomsLocal());
