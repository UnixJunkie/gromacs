...
/*! \internal \file
 * \brief
 * Tests for exclusions in the SIMD kernels
 *
...
// Class that sets up and holds a set of N atoms and a full NxN pairlist
class DiagonalExclusionsTest : public ::testing::TestWithParam<Nbnxm::KernelType>
{
public:
    DiagonalExclusionsTest()
    {
...
// Checks that the correct bits as set for avoiding double counting interactions around the diagonal
TEST_P(DiagonalExclusionsTest, CheckInteractionMask)
{
