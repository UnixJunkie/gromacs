...
void LegacySimulator::do_cg()
{
    ...
    /* Print to log file */
    print_em_start(fpLog_, cr_, wallTimeAccounting_, wCycle_, CG);
    ...
    finish_em(cr_, outf, wallTimeAccounting_, wCycle_);
...
void LegacySimulator::do_lbfgs()
{
    ...
    *sc = ems;
    ...
    /* Print to log file */
    print_em_start(fpLog_, cr_, wallTimeAccounting_, wCycle_, LBFGS);
    ...
    if (vSite_)
    {
        vSite_->construct(stateGlobal_->x, {}, stateGlobal_->box, VSiteOperation::Positions);
    }
...
void LegacySimulator::do_steep()
{
    ...
    /* Print to log file  */
    print_em_start(fpLog_, cr_, wallTimeAccounting_, wCycle_, SD);
...
void LegacySimulator::do_nm()
{
    ...
    print_em_start(fpLog_, cr_, wallTimeAccounting_, wCycle_, NM);
